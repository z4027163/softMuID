...
#                     ]
        model_files=[
#                     "results/weight_muon_mva_pt2/Run2022-20230926-1028-Event0.model",\
#                     "results/weight_muon_mva_pt2_isGlobal/Run2022-20230926-1056-Event0.model"]
#                     "results/weight_muon_mva_pt2_noGlobal/Run2022-20230926-1140-Event0.model"]
                      "results/unweight_muon_mva_pt2/Run2022-20230926-1356-Event0.model",\
                      "results/unweight_muon_mva_pt2_nopurity/Run2022-20230928-1445-Event0.model"]
#                      "results/unweight_muon_mva_pt2_isGlobal/Run2022-20230926-1419-Event0.model"]
                      #"results/unweight_muon_mva_pt2_noGlobal/Run2022-20230926-1441-Event0.model"]

        label_names=["unweighted training pt>2 (Global or Tracker)","unweighted training pt>2 (Global or Tracker, noPurity)"]
        #model.load_cat_file()
